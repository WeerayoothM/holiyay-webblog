...
function Home() {
    return (
        <div className="home-container" centerContent >
            ...
            <Container data-aos-delay="80" data-aos='fade-left' pt="82px" maxW="100%" >
                <Box width="100%" height="300px" overflow="hidden" style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', margin: '0' }}>
                    <Box p="6">
                        <Box d="flex" alignItems="baseline">
                            <Box
                                color="#fbdb48"
